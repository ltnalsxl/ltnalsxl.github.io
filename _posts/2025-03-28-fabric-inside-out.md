...
🧱 구조를 마주하며
2024년은 이직 후 처음 맞은 해였지만,
‘처음’이라는 단어가 무색할 만큼, 일에 대한 방향성도, 성과에 대한 피드백도 없이 조용히 흘러갔다.

내가 속한 조직의 문제라고 단정 짓고 싶진 않았지만,
적어도 팀 내의 일하는 방식과 관계의 흐름이 큰 영향을 줬다는 건 분명하다:

성과나 업무에 대한 피드백이 거의 없는 문화

일보다 사람 간 커뮤니케이션에 더 많은 에너지가 드는 구조

협업보다 개인 작업 중심의 운영, 지식 공유의 부재

명확한 방향성과 리더십이 작동하지 않는 환경

겉으로는 ‘능동적인 팀’을 지향한다고 이야기하지만,
실제로는 변화보다는 조용하고 평평한 흐름을 선호하는 분위기였다.
같은 부서 내 다른 팀에서도

“저 팀은 무슨 일을 하는 거야?”
라는 질문이 반복될 정도로 역할과 운영 방식이 뚜렷하지 않았다.

🎯 기대와 현실의 간극
나는 Digital Transformation과 BI 전환을 위한 인력으로 합류했다.
조직의 니즈와 방향성은 분명해 보였지만,
실제 팀 내부에서는 새로운 구조나 자동화 제안이
‘지금 당장 필요한 일’로 받아들여지기 어려운 분위기였다.

자동화, 구조화, 데이터 기반 프로세스를 제안하면

“굳이?”, “그걸 왜 힘들게 해?”, “그거 10분이면 내가 하는데”
와 같은 반응이 반복됐다.

결국, 의미 있는 시도 자체가 공감 없이 외로운 노동이 되는 구조 속에서
말을 줄이고, 최소한의 업무만 이어가는 방식으로 조정하게 되었다.

🔄 방향 전환을 결심하기까지
이직 후 1년, 스스로도 의욕을 잃었다.
무엇을 해도 돌아오는 피드백이 없고,
협업보다는 피로감이, 성장은커녕 정체만이 반복됐다.

"지금 제대로 가고 있는 걸까?”, “정말 이 환경이 이상한 게 맞긴 한걸까?”   하는 고민을 반복했고,  
"그렇다고 또 이직해?"라는 회의도 따라왔다.

하지만 시간이 흐르면서,
지금 이 자리에서 바꿀 수 있는 것이 무엇인지,
무시해도 되는 것과 집중해야 하는 것이 무엇인지
조금씩 명확해지기 시작했다.

그래서 2025년부터는,
환경을 탓하는 대신 실질적인 변화부터 만들어보기로 했다.
...
- **Hive DB 설계 → Presto 연결 → Tableau 대시보드 구축**  
    - 수작업으로 처리하던 주간 데이터 준비 시간을 분 단위 수준으로 단축
- **Python 기반 자동화 스크립트 개발**  
    - 데이터, 리포팅 흐름 등을 자동 처리해 오류 가능성 최소화 및 반복 업무 제거
- **Power Query, Microsoft Fabric, Power Automate 활용**  
    - 수작업 입력 80% 이상 제거, 프로세스 자동화
- 단순한 자동화 구현을 넘어서, 유지 가능하고 확장 가능한 플로우 설계까지 수행
