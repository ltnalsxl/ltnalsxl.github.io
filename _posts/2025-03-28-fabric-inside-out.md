...
모든 원인을 조직에만 둘 수는 없었다.  
익숙하지 않은 문화, 애매한 연차, 내 경험의 부족함까지 겹치며  
스스로도 점차 무기력해졌다.  

팀 내 구성원들의 일하는 방식과 관계의 흐름은  
나의 업무 경험 전반에 큰 영향을 미쳤다:

팀 내 구성원들의 일하는 방식과 관계의 흐름은  
나의 업무 경험 전반에 적지 않은 영향을 미쳤다:
...
실제로는 **변화보다는 조용하고 균일한 흐름을 더 선호하는 분위기**가 강하게 느껴졌다.  

같은 부서 내 다른 팀에서도  
> “저 팀은 무슨 일을 하는 거야?”  
라는 질문이 반복될 만큼, 팀의 역할과 운영 방식은 뚜렷하게 정의되지 않았다.
---
