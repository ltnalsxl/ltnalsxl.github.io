...
하지만 ‘처음’이라는 말이 무색할 만큼, 일에 대한 방향성과 성과에 대한 피드백 없이 시간이 흘렀다.

팀 내 구성원의 업무 방식과 관계의 흐름이 전반적인 경험에 큰 영향을 줬다:
...
겉으로는 능동적인 팀을 지향한다고 말했지만, 실제로는 변화보다는 조용하고 균일한 흐름을 선호하는 분위기가 강했다.  
같은 부서 내 다른 팀에서도 “저 팀은 무슨 일을 하는 거야?”라는 질문이 반복될 만큼 역할과 운영 방식은 명확하지 않았다.

### 기대와 현실의 간극

Digital Transformation과 BI 전환을 위한 역할로 팀에 합류했다.  
조직 차원에서는 변화의 필요성이 분명했지만, 팀 내부에서는 새로운 구조나 자동화 제안이 실질적인 필요로 받아들여지기 어려운 분위기였다.

“굳이?”, “그걸 왜 힘들게 해?”, “그거 내가 하면 10분이면 되는데.”  
자동화나 구조화에 대한 제안은 이러한 반응 속에서 공감대 형성이 쉽지 않았다.

결국 의미 있는 시도는 피드백 없이 외롭게 진행되었고, 일정 기간 동안은 말을 줄이고 최소한의 업무를 중심으로 역할을 조정하게 되었다.

### 방향 전환을 결심하기까지
이직 후 1년은 정체와 무기력의 연속이었다.  
무엇을 해도 피드백은 없었고, 협업보다는 피로감이, 성장은커녕 반복되는 정체감만 남았다.  

"지금 내가 제대로 가고 있는 걸까?",  
"내가 부족한 걸까, 아니면 이 환경이 잘못된 걸까?"라는 고민을 반복했고,  
"또 이직을 고려해야 하나?"라는 회의도 생겼다.  

하지만 시간이 지나면서  
지금 이 자리에서 바꿀 수 있는 것과 바꿀 수 없는 것,  
집중해야 할 것과 무시해도 될 것을 구분하는 감각이 생겼다.  

그래서 2025년부터는, **환경을 탓하기보다 변화의 시작점을 만들기로 했다.**
---
